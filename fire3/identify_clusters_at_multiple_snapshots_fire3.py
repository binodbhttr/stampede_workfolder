...
for s in range(snapnumber,696,3):
    ...
    part = gizmo.io.Read.read_snapshots(['all'],'snapshot_index', s, simulation_name=simname, simulation_directory=simdir, assign_hosts_rotation=True, assign_hosts=True)  
    ...
    if mtot[0]>0:
        ...
        file_name="fire3_clusters_"+simname+"_snapshot_"+str(s)+".pkl" 
        ...
        print("########\n#########\n No new clusters found in this snapshot.")
