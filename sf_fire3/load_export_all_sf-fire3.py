...
path="./sf-fire3data_pkl/" #creating a path to store the data only if it does not exist
...
cluster_path="./sf-fire3data_pkl/"
cluster_file_name="sf-fire3_clusters_"+simname+"_snapshot_"+str(snapshot_start) 
