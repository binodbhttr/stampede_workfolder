...
snap=586 #this is the snapshot at which the clusters were taken from using the fof algorithm I am using this to extract information from the snapshot where the clusters were first seen
snapshot_start=586  #snapshot to begin creating the figure
snapshot_end=586    #snapshot to stop at
