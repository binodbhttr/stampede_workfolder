...
# In[ ]:
snapshot_start=586
snapshot_end=586 #ran out of memory after 646


#Loading the sample cluster to be tracked and sorting its id and id_child
cluster_group="snapshot586" #Remember to change it if you  are changing the star cluster you are tracking in given snapshot
