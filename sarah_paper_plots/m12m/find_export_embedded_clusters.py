...
#this is just for m12m!  need to change name for m12i cloud catalog and input data for fof
...
file_name="m12m_fire2_clusters_"+simname+"_snapshot_"+str(snapnumber)+".pkl"
