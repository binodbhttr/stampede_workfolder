...
cluster_groupid="snapshot596_cluster_group04" #Remember to change it if you  are changing the star culuster you are tracking in given snapshot
...
#    ax.scatter(importdata[snap]['x_tracked'],importdata[snap]['y_tracked'],marker=".",s=importdata[snap]['mass_tracked']/100)
#    ax.plot(importdata[snap]['xcm'],importdata[snap]['ycm'],color='red',marker=".",markersize=1)
#    ax.set_xlabel('x')
#    ax.set_ylabel('y')
#    ax.minorticks_on()
#    ax.set_xlim(importdata[snap]['xmin'],importdata[snap]['xmax'])
#    ax.set_ylim(importdata[snap]['ymin'],importdata[snap]['ymax'])
