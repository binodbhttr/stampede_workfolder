...
datapath="./sf-fire3data_pkl/" #this is teh path where the data of our tracked clusters is
...
##############################
##############################
plot_path="./sf-fire3_plots_with_gas/" #creating a path to store the plots only if it does not exist
...
for i in range(len(time)):                              
    ...
    ###################
    file_name="sf-fire3_clusters_at_snapshot_"+str(snapnumber)+".pkl"
    ...
    fig1.savefig(plot_path+"sf-fire3_clusters_snap"+str(plot_count+snapshot_start)+".png",bbox_inches='tight',dpi=200)
    plot_count+=1
    fig1.clf()
    plt.close()
