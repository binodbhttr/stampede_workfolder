...
#SBATCH -J gas_data_fire2.py     # Job name Give a name for the job here good convention would include the simulation name
#SBATCH -o export_gas_data_fire2.o%j # Name of stdout output file
#SBATCH -e export_gas_data_fire2.e%j # Name of stderr error file
