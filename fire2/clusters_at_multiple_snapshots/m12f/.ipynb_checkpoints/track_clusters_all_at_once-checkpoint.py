...
path="/home1/07428/binod/work2/data/m12f_588_clusters_tracked_data_b4n5_pkl/" #creating a path to store the data only if it does not exist
...
for i in range(total_snaps):               #we run a for loop until the end of all snapshots
    ...
    for j in range(total_clusters):
        ...
        tracked_data={"ind_tracked":ind_tracked,"age_tracked":age_tracked,"x_tracked":x_tracked,
                      "y_tracked":y_tracked,"z_tracked":z_tracked,
