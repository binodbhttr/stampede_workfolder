...
datapath="./sf-fire3-alpha05data_pkl/" #this is teh path where the data of our tracked clusters is
...
fn="sf-fire3-alpha05_clusters_at_snapshot_"+str(snap)+".pkl"  #snap determines where the cluster was taken from
...
##############################
##############################
plot_path="./sf-fire3-alpha05_plots_with_gas/" #creating a path to store the plots only if it does not exist
...
for i in range(len(time)):                              
    ...
    ###################
    file_name="sf-fire3-alpha05_clusters_at_snapshot_"+str(snapnumber)+".pkl"
    ...
    label2="m12i mhdcv SF-FIRE3-Alpha05" 
    ...
    fig1.savefig(plot_path+"sf-fire3-alpha05_clusters_snap"+str(plot_count+snapshot_start)+".png",bbox_inches='tight',dpi=200)
    plot_count+=1
    fig1.clf()
    plt.close()
